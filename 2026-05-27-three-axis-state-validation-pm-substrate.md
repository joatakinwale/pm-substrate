...
**Tech Stack:** pm-substrate TypeScript/Vitest/Postgres; ArrowHedgeLabs Python/LangGraph/backtester; PluggedInSocial/Stevie Social FastAPI/Postgres/Next.js when cloned; local LLM/module lab using local model runners where available, deterministic fixtures, and substrate adapters.
...
- Create: `docs/state-validation/state-failure-taxonomy.md`

- [ ] **Step 1: Define failure classes**
...
- Create: `docs/state-validation/eval-event-schema.md`
- Later create: `packages/evals/src/schema.ts`
- Later test: `packages/evals/src/schema.test.ts`

- [ ] **Step 1: Define common eval event fields**
...
- [ ] **Step 2: Map eval events to substrate evidence**
