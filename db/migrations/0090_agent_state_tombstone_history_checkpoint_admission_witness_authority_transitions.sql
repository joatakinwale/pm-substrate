...
CREATE OR REPLACE FUNCTION agent_state.prevent_tombstone_history_checkpoint_admission_witness_authority_rewrite()
RETURNS trigger
LANGUAGE plpgsql
AS $$
BEGIN
  RAISE EXCEPTION 'tombstone history checkpoint admission witness authority transitions are append-only'
    USING ERRCODE = '42501';
END;
$$;
