-- 0115_agent_state_authority_epoch_seal_finalizer_proof_admission_witness_authority_transition_admission_witness_records.sql
...
CREATE TABLE IF NOT EXISTS agent_state.authority_epoch_seal_finalizer_proof_admission_witness_authority_transition_admission_witness_records (
...
CREATE INDEX IF NOT EXISTS fin_proof_adm_wit_auth_trans_adm_wit_scope_idx
  ON agent_state.authority_epoch_seal_finalizer_proof_admission_witness_authority_transition_admission_witness_records (
    tenant_id,
    transition_admission_witness_store_id,
...
CREATE TRIGGER prevent_fin_proof_adm_wit_auth_trans_adm_wit_record_rewrite
  BEFORE UPDATE OR DELETE ON agent_state.authority_epoch_seal_finalizer_proof_admission_witness_authority_transition_admission_witness_records
  FOR EACH ROW
  EXECUTE FUNCTION agent_state.prevent_fin_proof_adm_wit_auth_trans_adm_wit_record_rewrite();

REVOKE INSERT, UPDATE, DELETE ON agent_state.authority_epoch_seal_finalizer_proof_admission_witness_authority_transition_admission_witness_records FROM PUBLIC;

COMMENT ON TABLE agent_state.authority_epoch_seal_finalizer_proof_admission_witness_authority_transition_admission_witness_records IS
...
COMMENT ON COLUMN agent_state.authority_epoch_seal_finalizer_proof_admission_witness_authority_transition_admission_witness_records.admission_record_hash IS
...
COMMENT ON COLUMN agent_state.authority_epoch_seal_finalizer_proof_admission_witness_authority_transition_admission_witness_records.next_authority_topology_hash IS
...
COMMENT ON COLUMN agent_state.authority_epoch_seal_finalizer_proof_admission_witness_authority_transition_admission_witness_records.admission_certificate IS
  'Quorum certificate over the exact transition-admission store, topology id, admission sequence, and admission record hash.';

COMMENT ON COLUMN agent_state.authority_epoch_seal_finalizer_proof_admission_witness_authority_transition_admission_witness_records.witness_record_hash IS
