-- 0020_eval_action_outcome_envelope_packets.sql
-- Durable replay packets for terminal action outcome envelopes cited by eval events.
...
COMMENT ON TABLE evals.action_outcome_envelope_packets IS
  'Hash-verified terminal ActionOutcomeEnvelope packets referenced by EvalEvent substrate refs.';
