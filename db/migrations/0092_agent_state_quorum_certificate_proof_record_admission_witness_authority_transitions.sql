...
CREATE OR REPLACE FUNCTION agent_state.prevent_quorum_certificate_proof_record_admission_witness_authority_rewrite()
RETURNS trigger
LANGUAGE plpgsql
AS $$
BEGIN
  RAISE EXCEPTION 'quorum certificate proof-record admission witness authority transitions are append-only'
    USING ERRCODE = '42501';
END;
$$;
