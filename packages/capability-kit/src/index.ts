...
export {
  ...
  type WorkflowGraphWriteProjectionReplayCertificateStore,
  type WorkflowGraphWriteProjectionReplayCertificateStoreIssue,
  type WorkflowGraphWriteProjectionReplayCertificateStoreVerification,
  type WorkflowGraphWriteProjectionReplayRootSettlementStore,
  type WorkflowGraphWriteProjectionReplayRootSettlementCurrentnessPolicy,
  type WorkflowGraphWriteProjectionReplayRootSettlementStoreHead,
  type WorkflowGraphWriteProjectionReplayRootSettlementStoreHeadWitness,
  type WorkflowGraphWriteProjectionReplayRootSettlementStoreHeadWitnessDecision,
  type WorkflowGraphWriteProjectionReplayRootSettlementStoreHeadWitnessQuorum,
  type WorkflowGraphWriteProjectionReplayRootSettlementStoreHeadWitnessQuorumCertificate,
  type WorkflowGraphWriteProjectionReplayRootSettlementStoreIssue,
  type WorkflowGraphWriteProjectionReplayRootSettlementStoreVerification,
