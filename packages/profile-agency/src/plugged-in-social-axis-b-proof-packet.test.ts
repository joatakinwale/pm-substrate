...
import { buildThreeAxisProofPacket } from "@pm/evals";
...
describe("PluggedInSocial Axis B proof packet integration", () => {
  it.skipIf(!PLUGGED_IN_SOCIAL_AVAILABLE)("verifies live Axis B coverage without overclaiming the three-axis packet", () => {
