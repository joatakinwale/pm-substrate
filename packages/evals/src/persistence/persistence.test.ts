...
describe("PostgresEvalEventStore", () => {
  ...
  it("recovers graph write-authority envelope metadata from stored packets", async () => {
    ...
    expect(recovered).toEqual({
      ...
      projectionReplayRef: {
        certificateId: "projection_replay_eval_packet_001",
        certificateHash: "sha256:eval_projection_replay_certificate",
        projectionName: "arrowhedge/current-state",
        projectionVersion: 1,
        authorityScope: "arrowhedge:backtest",
        replayedToPosition: 42,
        transitionHistoryHash: "sha256:eval_transition_history",
        projectionHash: "sha256:eval_projection_hash",
        certificateStoreSequence: 9,
        certificateStoreEntryHash: "sha256:eval_certificate_store_entry",
        certificateStoreRootHash: "sha256:eval_certificate_store_root",
        checkedAt: "2026-05-27T15:00:00.000Z",
      },
      projectionReplayRootSettlementRef: {
        rootSequence: 9,
        rootHash: "sha256:eval_certificate_store_root",
        settlementSequence: 2,
        settlementStatus: "settled",
        settlementHash: "sha256:eval_root_settlement",
        settlementRecordHash: "sha256:eval_root_settlement_record",
        authorityTopologyHash: "sha256:eval_authority_topology",
        checkedAt: "2026-05-27T15:00:00.000Z",
      },
    });
  });
