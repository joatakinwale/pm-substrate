...
7. Add memory evolution/compaction/control-flow fixtures for patches, supersession, source refs, deletion residue, compaction replay fidelity, and memory-steered tool choice.
