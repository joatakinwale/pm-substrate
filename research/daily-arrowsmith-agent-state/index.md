...
25. Answer RQ41 by binding provider-certificate status event sequence/hash refs into workflow `ActionOutcomeEnvelope` evidence/substrate refs so replay cannot substitute a later or different status chain.
