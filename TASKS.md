...
| phase-safe plan/command/raw contracts complete; official execution blocked | `D6-C` | Run STATE-Bench held-out headline evaluation | [`public-benchmark-status-2026-07-13.md`](./docs/public-benchmark-status-2026-07-13.md) | Preserve the 20/80 train qualification/extraction partition and full 150-task test inventory; externally preregister the exact 2,250-cell confirmatory plan; instrument and independently attest every runner/provider/simulator/judge transport, hidden retry, terminal failure, treatment uptake, state replay, actual model, usage, cost, and latency. No official trajectory exists and hand-authored score-shaped output remains ineligible |
| old 27-cell design excluded; four-arm production replacement in progress | `D6-D` | Execute independent public Sentinel stress battery | [`public-benchmark-status-2026-07-13.md`](./docs/public-benchmark-status-2026-07-13.md) | Keep MicroHub qualification-only; use published speed 1 and one task-agnostic agent across no-durable-state, sham, plain-KV, and production-substrate arms; raw-replay provider/browser/state/process/upstream evidence; reject early no-op exit; run the frozen 12-task procedural holdout without replacement; then preregister a powered task-clustered confirmatory universe and retain every incomplete cell |
